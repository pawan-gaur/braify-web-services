package com.braify.feature.user.service;
...
public class UserService {
    ...
    public UserResponse toResponse(AppUser u) {
        ...
        OrgBranding branding = (org != null) ? org.getBranding() : null;

        Map<String, List<String>> featureRoleAccess = (!isPlatformAdmin && branding != null)
